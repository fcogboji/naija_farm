  ...
  return (
    <main className="max-w-2xl mx-auto p-6">
      ...
      <div className="mt-8 text-sm text-gray-700">
        ...
        <p>Email: <a href="mikennamdidollar@gmail.com" className="text-blue-600 underline">support@naijafarmmarket.com</a></p>
        <p>Phone: <a href="tel:+447888284708" className="text-blue-600 underline">+234 800 000 0000</a></p>
      </div>
    </main>
  );
}
